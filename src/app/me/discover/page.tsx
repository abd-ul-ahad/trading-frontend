          ...
          >
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                ...
                <div className="font-mono text-[12px] tracking-[0.12em] uppercase text-[#c8c3bb] mt-1">
                  Since {strategy.since}
                </div>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-mono text-[12px] tracking-[0.12em] uppercase text-[#c8c3bb]">
                  Risk
                </span>
            ...
            <p className="text-[15px] text-[#c8c3bb] leading-relaxed mb-5 border-b border-[rgba(255,255,255,0.05)] pb-5">
              {strategy.desc}
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-5">
              <div>
                ...
                <div className="font-outfit text-[18px] font-bold text-[#e8c84a] tracking-[-0.01em]">
                  {strategy.ytd}
                </div>
              </div>
              <div>
                ...
                <div className="font-outfit text-[18px] font-bold text-[#ff9090] tracking-[-0.01em]">
                  {strategy.maxDD}%
                </div>
              </div>
              <div>
                ...
                <div className="font-outfit text-[18px] font-bold text-white tracking-[-0.01em]">
                  {strategy.sharpe}
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <button className="font-outfit text-[13px] font-medium tracking-[0.02em] text-[#c8c3bb] border border-[rgba(255,255,255,0.08)] rounded-lg px-4 py-2.5 transition-all hover:text-[#e8e2da] hover:border-[rgba(255,255,255,0.18)] whitespace-nowrap">
                View Details
              </button>
            </div>
          </div>
