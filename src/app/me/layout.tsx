...
export default function AdminLayout({
  ...
  return (
    <>
      <div className="fixed top-[68px] left-0 right-0 z-[200] h-[50px] bg-[#080808] border-b border-[rgba(255,255,255,0.05)] flex items-stretch px-4 md:px-8 lg:px-16 overflow-x-auto">
        {tabs.map((tab) => (
          <Link
            key={tab.href}
            href={tab.href}
            className={`flex items-center gap-2 px-4 md:px-5 font-ui text-[13px] font-medium transition-all relative top-px border-b-2 whitespace-nowrap ${
              pathname === tab.href
